...
<!-- END SIGMA IMPORTS -->
<script src="linkurious.js/plugins/sigma.layout.forceAtlas2/worker.js"></script>
<script src="linkurious.js/plugins/sigma.layout.forceAtlas2/supervisor.js"></script>
<script src="linkurious.js/plugins/sigma.plugins.neighborhoods/sigma.plugins.neighborhoods.js"></script>
...
var config = {
		  node: {
		    ...
		    '<img src={{image}} alt="avatarimg" style="width:204px;height:128px;" align ="center"></div>'+
		    ' <div class="sigma-tooltip-body">' +
		    '    <table>' +
		    '      <tr><th>Name</th> <td>{{nombre}}</td></tr>' +
	...
	sigma.parsers.json("linkurious.js/myData/dr.json",s,
	      function fafa() {
	         // this below adds x, y attributes as well as size = degree of the node 
	         var i, nodes = s.graph.nodes(),len = nodes.length;
     
	         for (i = 0; i < len; i++) {
	             nodes[i].x = nodes[i].x * Math.random();
	             nodes[i].y = nodes[i].y * Math.random();
	         
	             nodes[i].label = nodes[i].nombre;
	         ...
	         var edges = s.graph.edges(),len2 = edges.length;
			         ...
			         edges[i].color = "#ccc"; 
			         edges[i].minEdgeSize = 0.5,
			         edges[i].maxEdgeSize = 7;
			         
			         edges[i].defaultEdgeHoverColor ="#000";
			         edges[i].enableEdgeHovering = true;
			         edges[i].edgeHoverColor ="edge";
			         edges[i].doubleClickEnabled=true;
